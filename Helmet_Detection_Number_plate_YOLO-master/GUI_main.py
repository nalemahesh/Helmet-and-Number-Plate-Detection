...
root.title("Helmet and Number Plate Recognization")
...
#
label_l1 = tk.Label(root, text="Helmet and Number Plate Recognization  System",font=("Times New Roman", 35, 'bold'),
                    background="#152238", fg="white", width=50, height=1)
